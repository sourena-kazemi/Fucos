...
function LandingPage() {
  return (
    <header className="flex flex-col mx-auto max-w-2xl relative px-5 lg:max-w-4xl mt-36 lg:mt-48 -z-20">
      <img
        src="/quotation.svg"
        alt="quotation mark"
      ...
      <div className="flex flex-col items-center gap-6 text-xl md:flex-row mt-32">
        <button className="bg-green text-darkGray rounded-3xl py-3 w-52 hover:scale-105 transition-all hover:bg-lightGreen active:scale-95">
          Start Now
        </button>
